...
NProduction = {
	...
	BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 0,	-- Base max efficiency for factories expressed in %.
...
NAI = {
	...
	TRADEABLE_FACTORIES_FRACTION = 0.4,			-- Will at most trade away this fraction of factories.
