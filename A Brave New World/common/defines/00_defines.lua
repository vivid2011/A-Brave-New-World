...
NProduction = {
	...
	BASE_FACTORY_START_EFFICIENCY_FACTOR = 0.1,	-- Base start efficiency for factories expressed in %.
	BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 0.1,	-- Base max efficiency for factories expressed in %.
